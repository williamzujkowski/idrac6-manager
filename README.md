...
idrac6-manager --host 192.168.1.172 --user root --pass calvin
...
docker-compose up
# or
docker run -p 8080:8080 idrac6-manager --host 192.168.1.172
```
...
--pass       Password (default: calvin, or IDRAC_PASS env)
...
export IDRAC_API_KEY=my-secret-key
```
...
go run ./cmd/server --host 192.168.1.172
```
